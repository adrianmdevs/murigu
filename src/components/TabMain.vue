...
<template>
    <div class="relative z-10 flex flex-col w-full min-h-screen rounded-xl lg:container lg:mx-auto ">
        <!--Tab Buttons-->
        <div class="flex w-full sticky top-0 bg-gray-200 dark:bg-black z-20 space-x-4 py-3.5 max-sm:px-3 justify-evenly">
            <button v-for="tab in tabs" 
                :key="tab.name" 
                @click="activeTab = tab.name"
                :class = "[
                    'w-1/2 py-4', activeTab == tab.name ? 
        ...
        <!--Tab content-->
        <div class="pt-10 overflow-y-auto z-10 bg-white dark:bg-secondary-dark rounded-xl">
